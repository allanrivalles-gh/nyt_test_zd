...
public class SwipeDismissTouchListener implements View.OnTouchListener
{
    ...
    public interface DismissCallbacks
    {
         ...
         */
        void onDismissingStarted(View view, @Nullable Object token);

        /**
         * Called when the view has been dismissed.
         *
         * @param view  The originating {@link android.view.View} dismissed.
         * @param token The optional token passed to this object's constructor.
         */
        void onDismissed(View view, @Nullable Object token);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent)
    {
        ...
        switch(motionEvent.getActionMasked())
        {
            ...
            case MotionEvent.ACTION_UP:
            {
                ...
                {
                    // dismiss
                    mCallbacks.onDismissingStarted(mView, mToken);
                    mView.animate()
    ...
    private void performDismiss()
    {
        ...
        animator.addListener(new AnimatorListenerAdapter()
        {
            ...
            public void onAnimationEnd(Animator animation)
            {
                mCallbacks.onDismissed(mView, mToken);
