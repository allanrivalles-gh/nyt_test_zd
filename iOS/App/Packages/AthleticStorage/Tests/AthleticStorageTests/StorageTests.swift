    ...
    import XCTest
    import UIKit
    @testable import AthleticStorage
    ...
    struct Resource {
        ...
        init(name: String, type: String, sourceFile: StaticString = #file) throws {
            ...
            self.url = resourcesFolderURL.appendingPathComponent(
                "\(name).\(type)",
                isDirectory: false
            )
        }
    ...
    class StorageTests: XCTestCase {
        ...
        func testSaveStructs() {
            do {
                ...
                let retrievedMessage = try Storage.retrieve(
                    "message.json",
                    from: .documents,
                    as: Message.self
                )
                ...
                let messageInFolderUrl = try Storage.url(
                    for: "Messages/Bob/message.json",
                    in: .documents
                )
                print("A message was saved as \(messageInFolderUrl.absoluteString)")
                let retrievedMessageInFolder = try Storage.retrieve(
                    "Messages/Bob/message.json",
                    from: .documents,
                    as: Message.self
                )
                ...
                let retrievedMessages = try Storage.retrieve(
                    "messages.json",
                    from: .documents,
                    as: [Message].self
                )
        ...
        func testAppendStructs() {
            do {
                ...
                let retrievedSingleMessage = try Storage.retrieve(
                    "single-message.json",
                    from: .documents,
                    as: [Message].self
                )
                ...
                let retrievedMultipleMessages = try Storage.retrieve(
                ...
                XCTAssert(
                    retrievedMessages[0] == messages[0] && retrievedMessages[1] == messages[1]
                )
                ...
                let retrievedOneMessage = try Storage.retrieve(
                    "one-message.json",
                    from: .caches,
                    as: [Message].self
                )
                ...
                let retrievedManyMessages = try Storage.retrieve(
                    "many-messages.json",
                    from: .documents,
                    as: [Message].self
                )
                ...
                let retrievedFewMessages = try Storage.retrieve(
                    "a-few-messages.json",
                    from: .documents,
                    as: [Message].self
                )
                XCTAssert(
                    retrievedFewMessages[0] == array[0] && retrievedFewMessages[1] == array[1]
                        && retrievedFewMessages[2] == array[2]
                        && retrievedFewMessages[3] == messages[3]
                )
                ...
                let retrievedArrayOfStructs = try Storage.retrieve(
                    "array-of-structs.json",
                    from: .documents,
                    as: [Message].self
                )
                XCTAssert(retrievedArrayOfStructs.count == (messages.count * 2))
                XCTAssert(
                    retrievedArrayOfStructs[0] == messages[0]
                        && retrievedArrayOfStructs.last! == messages.last!
                )
            } catch {
                fatalError(convertErrorToString(error))
            }
        ...
        func testSaveImages() {
            do {
                ...
                let retrievedImage = try Storage.retrieve(
                    "image.png",
                    from: .documents,
                    as: UIImage.self
                )
                ...
                let retrievedInFolderImage = try Storage.retrieve(
                    "Photos/image.png",
                    from: .documents,
                    as: UIImage.self
                )
                ...
                let retrievedImages = try Storage.retrieve(
                    "album/",
                    from: .documents,
                    as: [UIImage].self
                )
                ...
                let retrievedInFolderImages = try Storage.retrieve(
                    "Photos/summer-album/",
                    from: .documents,
                    as: [UIImage].self
                )
        ...
        func testAppendImages() {
            do {
                ...
                var retrievedImages = try Storage.retrieve(
                    "EmptyFolder2",
                    from: .documents,
                    as: [UIImage].self
                )
                ...
                retrievedImages = try Storage.retrieve(
                    "Folder/",
                    from: .documents,
                    as: [UIImage].self
                )
        ...
        func testSaveData() {
            do {
                ...
                let retrievedInFolderFile = try Storage.retrieve(
                    "Folder/file",
                    from: .documents,
                    as: Data.self
                )
                ...
                let retrievedFiles = try Storage.retrieve(
                    "several-files/",
                    from: .documents,
                    as: [Data].self
                )
                ...
                let retrievedInFolderFiles = try Storage.retrieve(
                    "Folder/Files/",
                    from: .documents,
                    as: [Data].self
                )
        ...
        func testAppendData() {
            do {
                ...
                let retrievedObject = try Storage.retrieve(
                    "EmptyFolder",
                    from: .documents,
                    as: [Data].self
                )
                ...
                var retrievedObjects = try Storage.retrieve(
                    "EmptyFolder2",
                    from: .documents,
                    as: [Data].self
                )
                ...
                retrievedObjects = try Storage.retrieve(
                    "Folder/",
                    from: .documents,
                    as: [Data].self
                )
        ...
        func testSaveAsDataRetrieveAsImage() {
            do {
                ...
                // Retrieve as image
                let retrievedFileAsImage = try Storage.retrieve(
                    "file",
                    from: .documents,
                    as: UIImage.self
                )
                ...
                let retrievedFilesAsImages = try Storage.retrieve(
                    "data-folder/",
                    from: .documents,
                    as: [UIImage].self
                )
        ...
        func testDocuments() {
            do {
                ...
                let retrievedImageInFolders = try Storage.retrieve(
                    "Folder1/Folder2/Folder3/image.png",
                    from: .documents,
                    as: UIImage.self
                )
        ...
        func testApplicationSupport() {
            do {
                ...
                try Storage.save(
                    ...
                    as: "Folder1/Folder2/Folder3/image.png"
                )
                ...
                XCTAssert(
                    Storage.exists("Folder1/Folder2/Folder3/image.png", in: .applicationSupport)
                )
                let retrievedImageInFolders = try Storage.retrieve(
                    "Folder1/Folder2/Folder3/image.png",
                    from: .applicationSupport,
        ...
        func testGetUrl() {
            do {
                ...
                // 1 struct
                try Storage.save(messages[0], to: .documents, as: "message.json")
                let messageUrlPath = try Storage.url(for: "message.json", in: .documents).path
                ...
                try Storage.save(images, to: .documents, as: "album")
                XCTAssert(Storage.exists("album", in: .documents))
                let folderUrlPath = try Storage.url(for: "album/", in: .documents).path
                    .replacingOccurrences(of: "file://", with: "")
        ...
        func testDoNotBackupAndBackup() {
            do {
                ...
                if let resourceValues = try? messageUrl.resourceValues(forKeys: [
                ...
                if let resourceValues = try? albumUrl.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
                ...
                if let resourceValues = try? message2Url.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
                ...
                if let resourceValues = try? album2Url.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
                ...
                // we have to create a new url to access its new resource values
                let newMessageUrl = try Storage.url(for: "Messages/message.json", in: .documents)
                if let resourceValues = try? newMessageUrl.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
                ...
                if let resourceValues = try? newAlbumUrl.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
                ...
                // we have to create a new url to access its new resource values
                let newMessage2Url = try Storage.url(for: "Messages/message2.json", in: .documents)
                if let resourceValues = try? newMessage2Url.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
                ...
                if let resourceValues = try? newAlbum2Url.resourceValues(forKeys: [
                    .isExcludedFromBackupKey
                ]),
                    let isExcludedFromBackup = resourceValues.isExcludedFromBackup
                {
        ...
        func testiOS11VolumeStorageResourceValues() {
            ...
            XCTAssert(
                Storage.availableCapacityForImportantUsage != nil
                    && Storage.availableCapacityForImportantUsage != 0
            )
            XCTAssert(
                Storage.availableCapacityForOpportunisticUsage != nil
                    && Storage.availableCapacityForOpportunisticUsage != 0
            )
            ...
            print(
                "Storage.availableCapacityForImportantUsage = \(Storage.availableCapacityForImportantUsage!)"
            )
            print(
                "Storage.availableCapacityForOpportunisticUsage = \(Storage.availableCapacityForOpportunisticUsage!)"
            )
            print("============================================================\n\n")
        }
        ...
        func testDirectoryEquitability() {
            let directories: [Storage.Directory] = [
                .documents, .caches, .applicationSupport, .temporary,
            ]
        ...
        func testCustomEncoderDecoder() {
            ...
            do {
                ...
                let retrievedUpdatedMessages = try Storage.retrieve(
                    "messages.json",
                    from: .documents,
                    as: [Message].self,
                    decoder: decoder
