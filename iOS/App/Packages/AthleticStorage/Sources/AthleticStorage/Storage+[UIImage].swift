    ...
    extension Storage {
        /// Save an array of images to storage
        ///
        /// - Parameters:
                ...
                for i in 0..<value.count {
                    ...
                    if let data = pngData {
                        ...
                        throw createError(
                            ...
                            recoverySuggestion:
                                "Make sure there are no corrupt images in the array."
                        )
                    }
        ...
        public static func append(_ value: UIImage, to path: String, in directory: Directory) throws
        {
            do {
        ...
        ///
        /// - Parameters:
        ///   - value: images to store to storage
        ///   - path: folder location to store the images (i.e. "Folder/")
        ///   - directory: user directory to store the images in
        /// - Throws: Error if there were any issues writing the images to storage
        public static func append(_ value: [UIImage], to path: String, in directory: Directory)
            throws
        {
            do {
        ...
        /// Retrieve an array of images from a folder on storage
        ///
        /// - Parameters:
